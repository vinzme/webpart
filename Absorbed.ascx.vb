...
Partial Class Absorbed
    ...
    Dim pubAbsTotal As Double = 0
    Dim pubAbsTotal2 As Double = 0
        ...
        Try
            ...
            If mReader.HasRows Then
                While mReader.Read()
                    ...
                    Label5.Text = Trim(mReader("order_no")) & "/I"
    ...
    Protected Sub GridView1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView1.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If Not IsDBNull(DataBinder.Eval(e.Row.DataItem, "cost")) Then
                If Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "cost")) = 0 Then
                    e.Row.Cells(0).Text = " "
                    e.Row.Cells(1).Text = " "
                    e.Row.Cells(2).Text = " "
                Else

                    e.Row.Cells(3).Text = Format(DataBinder.Eval(e.Row.DataItem, "cost"), "##,##0.00;(##,##0.00)")

                    pubAbsTotal += Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "cost"))
                End If
        ...
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            ...
            e.Row.Cells(3).Text = Format(pubAbsTotal, "##,##0.00;(##,##0.00)")
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        Label7.Text = Mid(GridView1.SelectedRow.Cells(1).Text.Trim, 1, 4) & Mid(GridView1.SelectedRow.Cells(1).Text.Trim, 6, 2)
        GridView2.DataBind()
    End Sub
    ...
    Private Sub CheckLoadSwitch()
        ...
        Try
            If pubDestin = "I" Then
                sSql = "Select order_type, substring(loadaccess_bwar,5,1) as loadaccess_bwar, substring(loadswitch,5,1) as loadswitches " & _
                        "from SES.scheme.and_soweb_users where userid = '" & pubUser.Trim & "'"
            Else
                sSql = "Select substring(loadswitch,5,1) as loadswitches from SES.scheme.and_soweb_users where userid = '" & pubUser.Trim & "'"
            End If
            Dim MySqlCmd As New SqlCommand(sSql, MySqlConn)
            Dim mReader As SqlDataReader
    ...
    Protected Sub GridView2_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles GridView2.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ' add the backlogTotal to the running total variables
            If Not IsDBNull(DataBinder.Eval(e.Row.DataItem, "SumOfCost")) Then

                e.Row.Cells(3).Text = Format(DataBinder.Eval(e.Row.DataItem, "SumOfCost"), "##,##0.00;(##,##0.00)")

                pubAbsTotal2 += Convert.ToDouble(DataBinder.Eval(e.Row.DataItem, "SumOfCost"))
        ...
        ElseIf e.Row.RowType = DataControlRowType.Footer Then
            e.Row.Cells(1).Text = "Total :"
            ' for the Footer, display the running totals
            e.Row.Cells(3).Text = Format(pubAbsTotal2, "##,##0.00;(##,##0.00)")
            e.Row.Cells(3).HorizontalAlign = HorizontalAlign.Right
            e.Row.Cells(3).Font.Size = 8
