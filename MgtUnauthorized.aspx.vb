...
Partial Class MgtUnauthorized
    ...
    Private Sub LogUnauthorizedUser()
        ...
        cmdUpdate.CommandText = "insert into SES.scheme.and_so_unauthorized(userid,app_module,app_domain,app_date,app_time) " & _
                        "values('" & pubUser.Trim & "','Sales Order','" & pubDomain.Trim & "','" & pubServerDate & "','" & _
                        pubServerTime & "')"
    ...
    Private Sub GetServerDateTime()
        ...
        Try
            ...
            sSql = "Select getdate() as logdate from SES.scheme.and_users where userid = 'ALVIN.DELEON'"
