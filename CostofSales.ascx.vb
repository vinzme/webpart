...
Partial Class CostofSales
        ...
        Try
            ...
            If mReader.HasRows Then
                While mReader.Read()
                    ...
                    Label5.Text = Trim(mReader("order_no")) & "/S"
                    Label6.Text = Trim(mReader("order_no")) & "/I"
    ...
    Private Sub CheckLoadSwitch()
        ...
        Try
            If pubDestin = "I" Then
                sSql = "Select order_type, substring(loadaccess_bwar,7,1) as loadaccess_bwar, substring(loadswitch,7,1) as loadswitches " & _
                        "from SES.scheme.and_soweb_users where userid = '" & pubUser.Trim & "'"
            Else
                sSql = "Select substring(loadswitch,7,1) as loadswitches from SES.scheme.and_soweb_users where userid = '" & pubUser.Trim & "'"
            End If
            ...
            If Not IsDBNull(DataBinder.Eval(e.Row.DataItem, "trans_date")) Then
                ...
                Else
                    If DataBinder.Eval(e.Row.DataItem, "amt1") > 0 Then
                        ...
                        e.Row.Cells(4).Text = Format(DataBinder.Eval(e.Row.DataItem, "amt1"), "##,##0.00;(##,##0.00)")
                    Else
                        e.Row.Cells(4).Text = " "
                    End If
                End If
                ...
                Else
                    If DataBinder.Eval(e.Row.DataItem, "amt2") < 0 Then
                        ...
                        e.Row.Cells(5).Text = Format(DataBinder.Eval(e.Row.DataItem, "amt2") * -1, "##,##0.00;(##,##0.00)")
                    Else
                        e.Row.Cells(5).Text = " "
                    End If
                End If
